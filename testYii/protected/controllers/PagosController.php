...
class PagosController extends Controller
{
	...
	public function actionView($id)
	{
		...
		if(isset($_POST['Deposito'])){
			$model_deposito->attributes=$_POST['Deposito'];
			$this->redirect(array('//deposito/create','id'=>$model_deposito->ID_Pago));
		}
		if(isset($_POST['Transferencia'])){
			$model_transferencia->attributes=$_POST['Transferencia'];
			$this->redirect(array('//transferencia/create','id'=>$model_transferencia->ID_Pago));
		}
		if(isset($_POST['TarjetasDebitoCredito'])){
			$model_TarjetasDebitoCredito->attributes=$_POST['TarjetasDebitoCredito'];
			$this->redirect(array('//tarjetasDebitoCredito/create','id'=>$model_TarjetasDebitoCredito->ID_Pago));
		}
