...
class TarjetasDebitoCreditoController extends Controller
{
	/**
	...
	{
		$model=new TarjetasDebitoCredito;
		...
		if(isset($_POST['TarjetasDebitoCredito']))
		{
			$model->attributes=$_POST['TarjetasDebitoCredito'];
	...
	{
		$dataProvider=new CActiveDataProvider('TarjetasDebitoCredito');
	...
	{
		$model=new TarjetasDebitoCredito('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['TarjetasDebitoCredito']))
			$model->attributes=$_GET['TarjetasDebitoCredito'];
	...
	{
		$model=TarjetasDebitoCredito::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='tarjetas-debito-credito-form')
		{
