	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				...
				'expression'=>'Yii::app()->user->checkAccess("usuario") || Yii::app()->user->checkAccess("administrador")',
				//'expression'=>'Yii::app()->user->getState("id_tipo")==$model->ID_Usuario || Yii::app()->user->checkAccess("administrador")',
			),
