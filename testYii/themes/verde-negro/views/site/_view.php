	...
	<table>
		<tr>
			...
			<td>
				...
				<font size="5" face="monospace"><?php echo CHtml::link(CHtml::encode($data->Nombre_Producto), array('producto/view', 'id'=>$data->ID_Producto)); ?></font>
				<br />
				
				<b><?php echo CHtml::encode($data->getAttributeLabel('Descripcion')); ?>:</b>
				<?php echo substr(CHtml::encode($data->Descripcion), 0,150).'...'; ?>
				<br />
